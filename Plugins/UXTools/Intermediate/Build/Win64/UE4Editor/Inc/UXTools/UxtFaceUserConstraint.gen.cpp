...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bFaceAway_MetaData[];
#endif
		static void NewProp_bFaceAway_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bFaceAway;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUxtFaceUserConstraint_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway = { "bFaceAway", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UUxtFaceUserConstraint), &Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUxtFaceUserConstraint_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUxtFaceUserConstraint_Statics::NewProp_bFaceAway,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UUxtFaceUserConstraint_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UUxtFaceUserConstraint()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UUxtFaceUserConstraint_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UUxtFaceUserConstraint, 1779547199);
	template<> UXTOOLS_API UClass* StaticClass<UUxtFaceUserConstraint>()
	{
		return UUxtFaceUserConstraint::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UUxtFaceUserConstraint(Z_Construct_UClass_UUxtFaceUserConstraint, &UUxtFaceUserConstraint::StaticClass, TEXT("/Script/UXTools"), TEXT("UUxtFaceUserConstraint"), false, nullptr, nullptr, nullptr);
