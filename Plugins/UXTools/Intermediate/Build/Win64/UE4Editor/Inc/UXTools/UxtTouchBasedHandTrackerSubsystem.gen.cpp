...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUxtTouchBasedHandTrackerSubsystem_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UUxtTouchBasedHandTrackerSubsystem_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UUxtTouchBasedHandTrackerSubsystem()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UUxtTouchBasedHandTrackerSubsystem_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UUxtTouchBasedHandTrackerSubsystem, 120553649);
	template<> UXTOOLS_API UClass* StaticClass<UUxtTouchBasedHandTrackerSubsystem>()
	{
		return UUxtTouchBasedHandTrackerSubsystem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UUxtTouchBasedHandTrackerSubsystem(Z_Construct_UClass_UUxtTouchBasedHandTrackerSubsystem, &UUxtTouchBasedHandTrackerSubsystem::StaticClass, TEXT("/Script/UXTools"), TEXT("UUxtTouchBasedHandTrackerSubsystem"), false, nullptr, nullptr, nullptr);
